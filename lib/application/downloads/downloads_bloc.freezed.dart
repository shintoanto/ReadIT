...
mixin _$DownloadsState {
  ...
  Option<Either<MainFailure, List<Downloads>>> get downloadsFailureOrSucces =>
      throw _privateConstructorUsedError;
...
abstract class $DownloadsStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      Option<Either<MainFailure, List<Downloads>>> downloadsFailureOrSucces});
}
...
class _$DownloadsStateImpl implements _DownloadsState {
  ...
  @override
  final Option<Either<MainFailure, List<Downloads>>> downloadsFailureOrSucces;

  @override
  String toString() {
    return 'DownloadsState(isLoading: $isLoading, downloads: $downloads, downloadsFailureOrSucces: $downloadsFailureOrSucces)';
  }
...
abstract class _DownloadsState implements DownloadsState {
  const factory _DownloadsState(
      ...
      required final Option<Either<MainFailure, List<Downloads>>>
          downloadsFailureOrSucces}) = _$DownloadsStateImpl;
